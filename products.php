...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Pick from our special collections</h1>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <?php foreach ($products as $product) { ?>
                <div class="panel panel-default">
                    ...
                    <p>
                              <img src="<?php echo $product['image'] ?>" alt="product image" height="100" width="100">
                        </p>           
                        <p>
                            <?php echo $product['description'] ?>
                        </p>

                        <h4>Price: <?php echo $product['price'] . ' ' . $product['currency'] ?></h4>
